		...
		public void WriteToExcel(JTable JTable_Param, String str_ColumnName[])
		{
			try
			{
				if (JTable_Param.getRowCount() > 0)
				{
						...
						String str_ExcelFile_Path_Name = ""; //"JAX-SeqDMA.xlsx";//name of excel file
					    ...
					    if(!str_ExcelFile_Path_Name.equals(""))
					    {
							...
							//JOptionPane.showMessageDialog(null, "Excel File Name: " + str_ExcelFile_Path_Name, "Data Missing", JOptionPane.PLAIN_MESSAGE);
